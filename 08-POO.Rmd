# Programmation orientée object à l'aide de classe R6
...
- ``private$`` permet d'appeler (dans la définition de la classe) les champes et les méthodes propres à la classe déclarés en private.
...
Pour diffuser un code, certains (dont JC) pensent qu'il vaut mieux refaire une surcouche qui s'appelle de maniere classique avec une fonction et des options.
